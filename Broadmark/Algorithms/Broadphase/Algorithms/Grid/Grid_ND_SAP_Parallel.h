...
#include "Grid_ND_SAP.h"


template<typename GridStructure>
class Grid_ND_SAP_Parallel : public GridStructure {
public:
...
typedef Grid_ND_SAP_Parallel<Grid_2D> Grid_2D_SAP_Parallel;
typedef Grid_ND_SAP_Parallel<Grid_3D> Grid_3D_SAP_Parallel;